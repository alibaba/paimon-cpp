...
public:
    ...
    static core::Result<LuminaBuilder> Create(const BuilderOptions& options) noexcept;
    ...
    core::Status Attach(api::IBuildExtension& ext) noexcept;
    ...
    core::Status Dump(const IOOptions& ioOptions) noexcept;
    core::Status Dump(std::unique_ptr<io::FileWriter> fileWriter, const IOOptions& ioOptions) noexcept;
