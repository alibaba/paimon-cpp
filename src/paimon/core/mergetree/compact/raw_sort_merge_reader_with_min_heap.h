...
class RawSortMergeReaderWithMinHeap : public SortMergeReader {
 public:
    RawSortMergeReaderWithMinHeap(
    ...
    class Iterator : public SortMergeReader::Iterator {
     public:
        explicit Iterator(RawSortMergeReaderWithMinHeap* reader) : reader_(reader) {}
     ...
     private:
        RawSortMergeReaderWithMinHeap* reader_;
 ...
 private:
    ...
    Result<bool> AdvanceCurrentElement();
 ...
 private:
    ...
    std::optional<Element> current_element_;
};
